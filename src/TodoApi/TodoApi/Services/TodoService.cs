...
{
    private readonly IRepository<TodoDocument> _repository;
    private readonly UserService _userService;

    public TodoService(IRepository<TodoDocument> repository, UserService userService)
    {
    ...
    public async Task UpdateAsync(string id, string todoContent, int todoPriority, List<string> todoSharedWith,
